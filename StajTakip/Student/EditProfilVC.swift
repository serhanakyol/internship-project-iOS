...
//  StajTakip
//
//  Created by Serhan Akyol on 4.07.2018.
...
class EditProfilVC: UIViewController ,UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let gestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(EditProfilVC.selectImage)) //tıklanınca gideceği fonk
        photoSelect.addGestureRecognizer(gestureRecognizer)
        
        nameText.text = UserDefaults.standard.string(forKey: "ad_soyad")!
